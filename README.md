...
*   **🎮 Total Control**  
    *   **Manual Start/Stop:** You decide when the service runs using the simple toolbar button. No accidental triggers.
    *   **Panic Cancel:** Press `ESC` at any time to immediately stop an active typing job.

*   **🧠 Smart Typing Modes**  
    *   **Human-Like:** Simulates natural typing speeds with random micro-delays (great for forms).
    *   **Paste:** Instantly injects large text blocks via clipboard (perfect for code).
    *   **Fast:** Rapid simulated keystrokes.
...
*   **Emergency Stop:** If a long snippet is typing and you need to stop it, just press `ESC`.
