...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::UI::Shell::IWindowTabTearOutRequestedEventArgs>{ using type = interface_category; };
    ...
    template <> struct category<Windows::UI::Shell::WindowTabTearOutRequestedEventArgs>{ using type = class_category; };
    ...
    template <> inline constexpr auto& name_v<Windows::UI::Shell::WindowTabTearOutRequestedEventArgs> = L"Windows.UI.Shell.WindowTabTearOutRequestedEventArgs";
    ...
    template <> inline constexpr auto& name_v<Windows::UI::Shell::IWindowTabTearOutRequestedEventArgs> = L"Windows.UI.Shell.IWindowTabTearOutRequestedEventArgs";
    ...
    template <> inline constexpr guid guid_v<Windows::UI::Shell::ITaskbarManagerDesktopAppSupportStatics>{ 0xCDFEFD63,0xE879,0x4134,{ 0xB9,0xA7,0x82,0x83,0xF0,0x5F,0x94,0x80 } };
    ...
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IWindowTab>{ 0x551E776A,0x7928,0x4D60,{ 0xBD,0xD9,0x67,0x2B,0x5A,0x57,0x58,0xEB } };
    ...
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IWindowTabGroup>{ 0xA9C2C4FE,0x6CFE,0x449C,{ 0x8B,0x57,0x57,0x56,0x77,0x1A,0xBE,0x56 } };
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IWindowTabIcon>{ 0xF92F398F,0x3669,0x4D0C,{ 0xA1,0x83,0x14,0xDD,0xAE,0x6F,0x65,0x38 } };
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IWindowTabIconStatics>{ 0x2E18D95E,0x2CBB,0x4084,{ 0xAF,0x0C,0x36,0xEE,0x1C,0x2D,0x54,0xB1 } };
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IWindowTabManager>{ 0x97B3C697,0xF43A,0x43E7,{ 0xB3,0xA2,0xE8,0x89,0xA9,0x83,0x55,0x99 } };
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IWindowTabManagerStatics>{ 0x76755668,0x45F0,0x4E0B,{ 0x81,0x72,0x4E,0x6D,0x9D,0x0F,0x87,0xBD } };
    ...
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IWindowTabTearOutRequestedEventArgs>{ 0x17D66659,0x5005,0x5ECE,{ 0x99,0xAF,0x56,0x63,0x06,0xE7,0x36,0x42 } };
    template <> inline constexpr guid guid_v<Windows::UI::Shell::IWindowTabThumbnailRequestedEventArgs>{ 0x2D558E54,0x9C4E,0x5ABC,{ 0xAB,0x72,0x33,0x50,0xFB,0x49,0x37,0xA0 } };
    ...
    template <> struct default_interface<Windows::UI::Shell::WindowTabTearOutRequestedEventArgs>{ using type = Windows::UI::Shell::IWindowTabTearOutRequestedEventArgs; };
    ...
    struct consume_Windows_UI_Shell_IWindowTabManager
    {
        ...
        WINRT_IMPL_AUTO(winrt::event_token) TabTearOutRequested(Windows::Foundation::TypedEventHandler<Windows::UI::Shell::WindowTabManager, Windows::UI::Shell::WindowTabTearOutRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] TabTearOutRequested_revoker TabTearOutRequested(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::UI::Shell::WindowTabManager, Windows::UI::Shell::WindowTabTearOutRequestedEventArgs> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(Windows::UI::Shell::WindowTabManager) GetForWindow(uint64_t windowId) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::UI::Shell::WindowTab) Tab() const;
        [[nodiscard]] WINRT_IMPL_AUTO(Windows::Graphics::Imaging::BitmapSize) RequestedSize() const;
