...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_UI_Shell_IWindowTabManager<D>::TabTearOutRequested(Windows::Foundation::TypedEventHandler<Windows::UI::Shell::WindowTabManager, Windows::UI::Shell::WindowTabTearOutRequestedEventArgs> const& handler) const
    {
        winrt::event_token token{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::UI::Shell::WindowTabManager) consume_Windows_UI_Shell_IWindowTabManagerStatics<D>::GetForWindow(uint64_t windowId) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::UI::Shell::WindowTab) consume_Windows_UI_Shell_IWindowTabTearOutRequestedEventArgs<D>::Tab() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Deferral) consume_Windows_UI_Shell_IWindowTabTearOutRequestedEventArgs<D>::GetDeferral() const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Graphics::Imaging::BitmapSize) consume_Windows_UI_Shell_IWindowTabThumbnailRequestedEventArgs<D>::RequestedSize() const
    {
