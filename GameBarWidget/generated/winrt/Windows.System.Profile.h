...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::System::Profile::PlatformAutomaticAppSignInPolicy) consume_Windows_System_Profile_IPlatformAutomaticAppSignInManagerStatics<D>::Policy() const
    {
        Windows::System::Profile::PlatformAutomaticAppSignInPolicy value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::Profile::IPlatformAutomaticAppSignInManagerStatics)->get_Policy(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
...
WINRT_EXPORT namespace winrt::Windows::System::Profile
{
    ...
    {
        return impl::call_factory_cast<Windows::System::Profile::PlatformAutomaticAppSignInPolicy(*)(IPlatformAutomaticAppSignInManagerStatics const&), PlatformAutomaticAppSignInManager, IPlatformAutomaticAppSignInManagerStatics>([](IPlatformAutomaticAppSignInManagerStatics const& f) { return f.Policy(); });
    }
