...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Gaming::Input::Preview::GameControllerBatteryChargingState) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::BatteryChargingState() const
    {
        Windows::Gaming::Input::Preview::GameControllerBatteryChargingState value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Gaming::Input::Preview::ILegacyGipGameControllerProvider)->get_BatteryChargingState(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Gaming::Input::Preview::GameControllerBatteryKind) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::BatteryKind() const
    {
        Windows::Gaming::Input::Preview::GameControllerBatteryKind value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Gaming::Input::Preview::ILegacyGipGameControllerProvider)->get_BatteryKind(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Gaming::Input::Preview::GameControllerBatteryLevel) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::BatteryLevel() const
    {
        Windows::Gaming::Input::Preview::GameControllerBatteryLevel value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Gaming::Input::Preview::ILegacyGipGameControllerProvider)->get_BatteryLevel(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(Windows::Gaming::Input::Preview::GameControllerFirmwareCorruptReason) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::GetDeviceFirmwareCorruptionState() const
    {
        Windows::Gaming::Input::Preview::GameControllerFirmwareCorruptReason value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Gaming::Input::Preview::ILegacyGipGameControllerProvider)->GetDeviceFirmwareCorruptionState(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IVectorView<hstring>) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::PreferredTypes() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::ExecuteCommand(Windows::Gaming::Input::Preview::DeviceCommand const& command) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::SetHeadsetOperation(Windows::Gaming::Input::Preview::HeadsetOperation const& operation, array_view<uint8_t const> buffer) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(com_array<uint8_t>) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::GetHeadsetOperation(Windows::Gaming::Input::Preview::HeadsetOperation const& operation) const
    {
        uint32_t buffer_impl_size{};
        uint8_t* buffer{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::SetStandardControllerButtonRemapping(Windows::System::User const& user, bool previous, param::map_view<Windows::Gaming::Input::Preview::RemappingButtonCategory, Windows::Foundation::IInspectable> const& remapping) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Foundation::Collections::IMapView<Windows::Gaming::Input::Preview::RemappingButtonCategory, Windows::Foundation::IInspectable>) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider<D>::GetStandardControllerButtonRemapping(Windows::System::User const& user, bool previous) const
    {
        void* remapping{};
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Gaming::Input::Preview::LegacyGipGameControllerProvider) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProviderStatics<D>::FromGameController(Windows::Gaming::Input::IGameController const& controller) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(Windows::Gaming::Input::Preview::LegacyGipGameControllerProvider) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProviderStatics<D>::FromGameControllerProvider(Windows::Gaming::Input::Custom::IGameControllerProvider const& provider) const
    {
        void* legacyGipGameControllerProvider{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProviderStatics<D>::PairPilotToCopilot(Windows::System::User const& user, param::hstring const& pilotControllerProviderId, param::hstring const& copilotControllerProviderId) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProviderStatics<D>::ClearPairing(Windows::System::User const& user, param::hstring const& controllerProviderId) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProviderStatics<D>::IsPilot(Windows::System::User const& user, param::hstring const& controllerProviderId) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProviderStatics<D>::IsCopilot(Windows::System::User const& user, param::hstring const& controllerProviderId) const
    {
